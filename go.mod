...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20230303180609-9b7e88df932b
...
replace github.com/ledgerwatch/erigon-lib => github.com/sentioxyz/erigon-lib v0.0.0-20231020073732-9d959ebaf1f9
